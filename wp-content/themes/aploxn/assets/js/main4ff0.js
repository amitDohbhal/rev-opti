(function ($) {
		...
		if ($('#archive-load-more').length) {
			...
			$('#archive-load-more').on('click', function (e) {
				...
				if (!loading) {
					...
					$(".primary-btn1.btn-hover.loading").addClass("gif");
						...
						success: function (response) {
							...
							if (response) {
								...
								if (response.trim() !== 'No data') {
									$('#people-archive').append(response);

									$(".primary-btn1.btn-hover.loading").removeClass("gif");
			...
			$('#archive-load-more').on('click', function (e) {
				...
				if (!loading) {
					...
					$.ajax({
						...
						url: loadmore.ajaxurl,
						data: {
							action: 'load_more_people_style_one',
							page: page
							// Add any additional parameters if needed
						},
						success: function (response) {
	...
	// End people style one archive ajax 

	// people style two archive ajax
	jQuery(function ($) {
		var page = 1;
		var loading = false;
		if ($('#archive-load-more').length) {
			...
			$('#archive-load-more').on('click', function (e) {
				...
				if (!loading) {
					...
					$.ajax({
						...
						url: loadmore.ajaxurl,
						data: {
							action: 'load_more_people_style_two',
							page: page
							// Add any additional parameters if needed
						},
						success: function (response) {
	...
	// End people style two archive ajax

	// people style three archive ajax
	jQuery(function ($) {
		var page = 1;
		var loading = false;
		if ($('#archive-load-more').length) {
			...
			$('#archive-load-more').on('click', function (e) {
				...
				if (!loading) {
					...
					$.ajax({
						...
						url: loadmore.ajaxurl,
						data: {
							action: 'load_more_people_style_three',
							page: page
							// Add any additional parameters if needed
						},
						success: function (response) {
	...
	// End people style three archive ajax

	jQuery(function ($) {
		var page = 1;
		var loading = false;
		if ($('#archive-load-more-case').length) {

			$('#archive-load-more-case').on('click', function (e) {
				e.preventDefault();
					...
					$.ajax({
						...
						success: function (response) {
							...
							if (response) {
								...
								if (response.trim() !== 'No data') {
									$('#case-study-archive').append(response);

									$(".primary-btn1.btn-hover.loading").removeClass("gif");

								} else {
									$('#archive-load-more-case').hide();
								}
	...
	jQuery(function ($) {
		var page = 1;
		var loading = false;
		if ($('#archive-load-more-event').length) {

			$('#archive-load-more-event').on('click', function (e) {
				e.preventDefault();
					...
					$.ajax({
						...
						success: function (response) {
							...
							if (response) {
								...
								if (response.trim() !== 'No data') {
									$('.row.g-4.mb-60').append(response);

									$(".primary-btn1.btn-hover.loading").removeClass("gif");

								} else {
									$('#archive-load-more-event').hide();
								}
							...
							if (response) {
								if (response.trim() !== 'No data') {
									...
									$('.nav-link').on('click', function () {
										...
										if (clickedId) {
											// Remove the "-tab" part
											var modifiedId = clickedId.replace('-tab', '');
											// Use the modifiedId as needed
